...
---@field name string The name of the player that interacted with the screen
---@field pressType integer The press type of the player 1: interaction | 2: tinker
...
---@field velocity Vec3 The velocity of the target.
---@field mass number The mass of the object.
---@field isDynamic boolean Whether the object is dynamic or not (always true for units).
---@field surfaceArea number The total surface area that the radar can see.
---@field type "creation"|"unit" The type of the object the radar can see (Currently 'creation' or 'unit').
---@field id integer The id of the object, (dependant on type).
...
---@return Keyboard[] Keyboards All connected Keyboards
...
function sc.vec3.toRadians(vec3) end
